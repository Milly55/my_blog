...
<body>
    ...
    <div class="mobile-top-bar flex">
        <div class="logo-box flex"><a href="/"><img src="https://ifh.cc/g/OKu0GT.png alt="
                    style="width: 60px; height: 50px;"></a></div>
    ...
    <div class="mobile-side-menu-bar visible-sm-down flex">
        <ul class="flex">
            ...
            <li class="flex "><a href="#">list</a>
                <ul class="flex ">
                    <li class="flex " style=" border-bottom: 1px solid #afafaf;"><a href="/list_cate.php?cateItemId=1">
                            일상</a></li>
                    <li class="flex " style=" border-bottom: 1px solid #afafaf;"><a href="/list_cate.php?cateItemId=2">
                            프로그래밍</a></li>
    ...
    <div class="top-bar con">
        <div class="menu-bar ">
            <nav class="menu-box-1 con">
                <ul class="flex  ">
                    <li>
                        <div class="logo-box flex"><a href="/"><img
                                    src="https://milly55.github.io/img1/blog/article/logo/logo.png" alt=""></a></div>
                    </li>
                    <li class="flex "><a href="/">Home</a></li>
                    <li class="flex  "><a href="/portfolio.php">Portfolio</a></li>
                    <li class="flex  "><a href="/about me.php">About Me</a></li>
