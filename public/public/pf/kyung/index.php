...
<head>
    ...
    <link rel="stylesheet" href="/pf/kyung/index.css">
    <script src="/pf/kyung/index.js"></script>
    <title>경동</title>
</head>
<body>
...
<div class="menu-bar">
    <div class="menu-box con flex">
        ...
        <ul class="menu-1 flex">
            <div class="img-box"><a href="#"><img src="https://milly55.github.io/img1/pf/kyung/logo_pc.png" alt=""></a></div>
            <li class="flex" style="margin-left:50px;"><a href="#">회사소개</a>
                <ul class="flex">
                    <li><a href="#">CEO인사말</a></li>
                    <li><a href="#">경영이념</a></li>
                    <li><a href="#">연혁</a></li>
                    <li><a href="#">C.I</a></li>
                    <li><a href="#">관계사 소개</a></li>
                    <li><a href="#">오시는 길</a></li>
                </ul>
            </li>
            <li class="flex"><a href="#">사업분야</a>
                <ul>
                    <li><a href="#">국내자원개발</a></li>
                    <li><a href="#">해외자원개발</a></li>
                    <li><a href="#">앤지니어링사업</a>
                        <ul>
                            <li><a href="#">- 광산&일반장비</a></li>
                            <li><a href="#">- 발전소</a></li>
                            <li><a href="#">- 공사업</a></li>
                            <li><a href="#">- 기술개발연구</a></li>
                            <li><a href="#">- 자료실</a></li>
                        </ul>
                    </li>
                    <li><a href="#">입대사업</a>
            ...
            <li class="flex"><a href="#">기술혁신</a>
                <ul>
                    <li><a href="#">경동의신기술</a></li>
                    <li><a href="#">광산안전시스템</a></li>
                </ul>
            </li>
            <li class="flex"><a href="#">홍보센터</a>
                <ul>
        ...
        <div class="icon-box flex">
            <ul class="flex">
                <li class="flex"><a href="#">KOR</a></li>
                <li class="flex"><a href="#">ENG</a></li>
...
<div class="popup-box-1">
    <div class="popup">
        ...
        <div class="body flex">
            <ul class="flex">
                <li class="flex"><a href="#"> 회사소개</a>
                    <ul class="flex">
                        <li><a href="#">CEO 이사말</a></li>
                        <li><a href="#">경영이념</a></li>
                        <li><a href="#">연혁</a></li>
                        <li><a href="#">C.I</a></li>
                        <li><a href="#">관계사 소개</a></li>
                ...
                <li class="flex" style="padding-left:80px;"><a href="#"> 사업분야</a>
                    <ul>
                        <li><a href="#">국내자원개발</a></li>
                        <li><a href="#">해외자원개발</a></li>
                        <li style="border-bottom:1px solid #afafaf;"><a href="#" style="border-bottom:0;">앤지니어링사업</a>
                            <ul>
                                <li><a href="#">- 광산&일반장비</a></li>
                                <li><a href="#">- 발전소</a></li>
                                <li><a href="#">- 공사업</a></li>
                                <li><a href="#">- 기술개발연구</a></li>
                                <li style="padding-bottom:20px;"><a href="#">- 자료실</a></li>
                            </ul>
                        </li>
                        <li><a href="#">입대사업</a></li>
                    </ul>
                ...
                <div>
                    <li class="flex" style="padding-left:80px;"><a href="#">기술혁신</a>
                        <ul>
                            <li><a href="#">경동의신기술</a></li>
                            <li><a href="#">광산안전시스템</a></li>
                        </ul>
                    </li>
                    <li class="flex" style="padding-left:80px;"><a href="#">홍보센터</a>
                        <ul>
                            <li><a href="#">특허및 인증 현황</a></li>
                            <li><a href="#">사회공헌활동</a></li>
                        </ul>
                    </li>
                </div>
            ...
            <ul class="flex">
                <li>
                    ...
                    <ul class="flex">
                        ...
                        <li style=" margin-top:20px; color: gray;">경동은 수십년간 축척된 경험과 광산운영 <br> 전반의 기술력을 보유하고 있습니다.</li>
                    </ul>
                </li>
                <li>
                    <div class="middle-img-box">
                    ...
                    <ul class="flex">
                        ...
                        <li style=" margin-top:20px; color: gray;">호주, 인도네시아를 거쳐 해외자원개발에 <br> 끊임없는 노력을 하고 있습니다.</li>
                    </ul>
                </li>
                </ul>
                <ul class="flex">
                <li>
                    ...
                    <ul class="flex">
                        ...
                        <li style="  margin-top:20px; color: gray;">축척된 기술력과 지속적인 기술개발로 <br> 광산장비설계 및 제작, 각종 plant 설계 및 <br> 시공 기술을 보유하고 있습니다. </li>
                    </ul>
                </li>
                <li>
                    <div class="middle-img-box">
                    ...
                    <ul class="flex">
                        ...
                        <li style=" margin-top:20px; color: gray; ">쾌적한 사무환경, 우수한 교통접근성은 <br> 경동빌딩의 자랑입니다.</li>
                    </ul>
                </li>
                </ul>
        </div>
            ...
            <li class="flex">
                ...
                <div class="background-img-txt flex">
                    <ul>
                        <li >경동의신기술</li>
                        <li>Technology</li>
                        <li><i class="far fa-arrow-alt-circle-down"></i></li>
                    </ul>
                </div>
                <ul class="flex">
                    <li>경동은 지속적인 기술개발과 투자로 국내광산 <br> 최고의 기술력을 자랑하고 있습니다.</li>
                    <li>
                        <div class="more-box-2 con-1 flex">
                            <a href="#">
                                <div class="more-link-2">View More</div>
                            </a>
                        </div>
                    </li>
                </ul>
        ...
        <div class="bottom-box flex  ">
            ...
            <ul class="bottom-txt flex" >
                ...
                <li style="margin-top:30px;">
                    <div class="more-box-3 con-1 flex">
                        <a href="#">
                            <div class="more-link-3">View More</div>
                        </a>
                    </div>
                </li>
            </ul>
            ...
            <div class="img-box flex" style="background-image:url(https://milly55.github.io/img1/pf/kyung/main_foot_bg.jpg)">
                <div class="bottom-txt-2 con-1 flex">
                    <ul class="bottom-1 flex">
                        <li >ABOUT</li>
                        <li >KYUNGDONG</li>
                        <li style=" margin-top:20px;">서민연료의 연탄에서 신재생 에너지까지 에너지를 통한 <br> 따뜻한 삶의 공간 창조 바로 경동이 합께합니다.</li>
                        <li style="margin-top:25px;">
                            <div class="more-box-4 con-1 flex">
                                <a href="#">
                                    <div class="more-link-4">View More</div>
                                </a>
                            </div>
                        </li>
                    </ul>
