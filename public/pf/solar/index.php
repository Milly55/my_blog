            ...
            <div class="main-txt-box " style="position:absolute; min-width:1679px;">
                ...
                <div class="btn-show-box-1 con flex">
                    <a href="#"><nav class="btn-show-popup-1">솔라시도의 도전 <i class="far fa-play-circle"></i></nav></a>
                     <a href="#"><nav class="btn-show-popup-2" style="padding:0 20px;">솔라시도 스케치 <i class="far fa-play-circle"></i></nav></a>
                </div>
                <!--동영상 팝업-->
                <div class="popup-box-1 popup-box-type-a">
                    <div class="popup">
                        ...
                        <div class="body">
<iframe width="1150" height="640" src="https://www.youtube.com/embed/LG3tLfF-9yg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <a href="#">
                                <div class="popup-a ">
            ...
            <!--동영상 팝업-->
                ...
                <div class="popup-box-2 popup-box-type-a">
                    <div class="popup">
                        ...
                        <div class="body">
<iframe width="1150" height="640" src="https://www.youtube.com/embed/BxdFb3x8Izw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <a href="#">
                                <div class="popup-a ">
                                    <div class="popuop-txt"><i class="fas fa-times"></i></div>
                                </div>
...
<section class="middle-bar-1 row ">
    ...
    <div class="middle-box-a middle-box-1 con row">
        <div class="middle-box-2 flex ">
             <div class="middle-txt-box row">
            <h3 class="txt-1 cell">About 솔라시도</h3>
        </div>
            <div class="txt-2">
                솔라시도는 천혜의 자연자원과 인간의 과학 문명이 결합하여
                <br>
만들어가는 미래 도시입니다.
                <br>
...
<section class="middle-bar-2  row ">
    <div class="middle-box-a middle-box-3 con row">
                     <div class="middle-txt-box row">
            <h3 class="txt-1 cell">About 솔라시도</h3>
        </div>
