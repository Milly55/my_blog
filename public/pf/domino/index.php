             ...
             <div class="img-box" style="background-image:url(https://milly55.github.io/img1/pf/domino/main-2.png)">
                 <div class="img-txt-box-2 img-txt flex">
                     <ul>
                         ...
                         <li style="font-size: 50px; font-weight: 450;">피자 <span
                                 style=" color: #FC2727; font-weight: bold;">40% 할인</span></li>
     ...
     <div class="middle-box-3 flex">
         <div class="domino-youtube-box flex">
             <nav class="domino-youtube-1 youtube">
                 <iframe width="560" height="430" src="https://www.youtube.com/embed/vAZAl1hLTgw" frameborder="0"
                     allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                     allowfullscreen></iframe>
             </nav>
             <nav class="domino-youtube-2 youtube">
                 <iframe width="560" height="430" src="https://www.youtube.com/embed/Px6L1cNxeGk" frameborder="0"
                     allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                     allowfullscreen></iframe>
             </nav>
         </div>
         <div class="domino-ebant-box flex">
             ...
             <div class="my-slider-2 con">
                 <div class="owl-carousel owl-theme meddil-silder-box">
                     ...
                     <div class="item"
                         style="background-image:url(https://milly55.github.io/img1/pf/domino/main_card4-2.png)"></div>
                     <div class="item"
