...
<div class=" slider-bar  con">
    <div class="slider-box-1 ">
        ...
        <div style="background-image:url(https://ifh.cc/g/hfpeGI.jpg);">
        <div class="btn-txt-bar flex">
        <div class="btn-txt-box flex">
            <div class="btn-txt-1">Welcome D&B 블로그</div>
        </div>
        ...
        <div style="background-image:url(https://ifh.cc/g/wm0e2u.jpg);">
        <div class="btn-txt-bar flex">
        <div class="btn-txt-box flex">
            <div class="btn-txt-1">Welcome D&B 블로그</div>
        </div>
        ...
        <div style="background-image:url(https://ifh.cc/g/oOZYsG.jpg);">
        <div class="btn-txt-bar flex">
        <div class="btn-txt-box flex">
            <div class="btn-txt-1">Welcome D&B 블로그</div>
        </div>
